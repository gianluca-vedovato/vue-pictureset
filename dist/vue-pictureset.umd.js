(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-pictureset"] = factory();
	else
		root["vue-pictureset"] = factory();
...
// CONCATENATED MODULE: ./src/PictureSetContentful.vue?vue&type=template&id=646990bb&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/PictureSetContentful.vue?vue&type=script&lang=js&
...
//
//
/* harmony default export */ var PictureSetContentfulvue_type_script_lang_js_ = ({
  props: {
    src: {
      type: String,
      required: true
...
// CONCATENATED MODULE: ./src/PictureSetContentful.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_PictureSetContentfulvue_type_script_lang_js_ = (PictureSetContentfulvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/PictureSetContentful.vue
...
var component = normalizeComponent(
  src_PictureSetContentfulvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"11a5983f-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/PictureSetSanity.vue?vue&type=template&id=6d19e75c&
var PictureSetSanityvue_type_template_id_6d19e75c_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('picture',[_vm._l((_vm.srcset),function(source,index){return _c('source',{key:index,attrs:{"srcset":source.src,"media":("(min-width: " + (source.media) + "px)"),"type":source.type}})}),_c('img',{class:_vm.imgClass,style:(_vm.imgStyle),attrs:{"src":_vm.src + '?q=5',"alt":_vm.alt,"title":_vm.title,"loading":_vm.loading},on:{"load":_vm.loaded}})],2)}
var PictureSetSanityvue_type_template_id_6d19e75c_staticRenderFns = []


// CONCATENATED MODULE: ./src/PictureSetSanity.vue?vue&type=template&id=6d19e75c&
      ...
      get: function get() {
        ...
        if (Array.isArray(this.size)) {
          ...
          return this.size.map(function (item) {
            var densityJpg = Array.from(Array(2).keys()).map(function (i) {
              ...
              return "".concat(_this.src, "?").concat(attrs, "&fm=").concat(ext, "&q=").concat(_this.quality.default, " ").concat(i + 1, "x");
            }).join(', ');
            var densityWebp = Array.from(Array(2).keys()).map(function (i) {
              var attrs = Object.keys(item.attr).map(function (attr) {
                if (attr === 'w' || attr === 'h') return "".concat(attr, "=").concat(item.attr[attr] * (i + 1) > 2048 ? 2048 : parseInt(item.attr[attr] * 0.75) * (i + 1));
              ...
              return "".concat(_this.src, "?").concat(attrs, "&fm=webp&q=").concat(_this.quality.webp, " ").concat(i + 1, "x");
            }).join(', ');
            return [{
              src: densityWebp,
              media: item.media,
        ...
        if (typeof this.size === 'number') {
          ...
          return this.mediaQueries.map(function (media, i) {
            var w = i !== 0 ? _this.size * _this.mediaQueries[i - 1] : _this.size * media;
            var densityJpg = Array.from(Array(2).keys()).map(function (i) {
              return "".concat(_this.src, "?w=").concat(w, "&fit=").concat(_this.fit, "&fm=").concat(_ext, "&q=").concat(_this.quality.default, " ").concat(i + 1, "x");
            }).join(', ');
            var densityWebp = Array.from(Array(2).keys()).map(function (i) {
              return "".concat(_this.src, "?w=").concat(w, "&fit=").concat(_this.fit, "&fm=webp&q=").concat(_this.quality.webp, " ").concat(i + 1, "x");
            }).join(', ');
            return [{
              src: densityWebp,
              media: media,
...
var PictureSetSanity_component = normalizeComponent(
  ...
  PictureSetSanityvue_type_template_id_6d19e75c_render,
  PictureSetSanityvue_type_template_id_6d19e75c_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var src_0 = (PictureSetInstall);
...
//# sourceMappingURL=vue-pictureset.umd.js.map